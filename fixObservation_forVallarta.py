...
OBS_file_name = '../dataFiles/observaciones/2015/vallarta_obs.txt'
FOR_file_name = '../dataFiles/observaciones/2015/vallarta_marpron.txt'
...
pronobsts.index = pronobsts.index.tz_localize('Etc/GMT+2').tz_convert('UTC')

#Print to CSV file.
pronobsts.to_csv('../dataFiles/observaciones/2015/fixed/vallarta.txt',sep=' ',na_rep='nan',date_format='%Y-%m-%d %H %M %S',index_label='date',quotechar=' ')
#pronobsts.plot()
#plt.show()
