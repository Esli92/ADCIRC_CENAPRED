...
for node in range(0,77):
    ...
    ssh_series = pd.DataFrame({'ssh_hycom' : serobs[ 'ssh_hycom'],'ssh_adcirc' : serobs[ 'zeta_adcirc'] - serobs[ 'zetanossh_ad']})
    ...
    mag_series.plot(title='Series de tiempo magnitud para el nodo {}'.format(node))
