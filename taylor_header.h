...
# RESOLUCION 0.5
#------- ESTACION ACO -----------------------------------------------------------------------------------------------------------------------------
DAT_5_ALL_ACO <- read.table("../dataFiles/pares/INTERVALO/monthlyPairs/pom/24780_mSEASON.txt",sep = ",", header = TRUE, fill = FALSE)
OBS_5_ALL_ACO <- DAT_5_ALL_ACO$OBSERVACION
FCT_5_ALL_ACO <- DAT_5_ALL_ACO$PRONOSTICO

jpeg(file = "./plots/taylor/TAYLOR_INTERVALO_mSEASON.jpg", width=1900,height=1300,units="px",quality=90,pointsize=26)

taylor.diagram(OBS_5_ALL_ACO,FCT_5_ALL_ACO,add=FALSE,col="red",pch=16,pos.cor=FALSE,
