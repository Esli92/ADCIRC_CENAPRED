...
statnames = ['Acapulco','Pto Angel','Huatulco','Lzo Card','Salina Cruz','Mazatlan','Pto Vallarta']
stations = ['17522','17615','17624','19545','21037','23758','24780']
...
for intervalo in intervalos:
    ...
    for station in stations:
        ...
        for month in range(1,13):
            ...
            serfile='../dataFiles/pares/{}/monthlyPairs/pom/{}_m{}.txt'.format(intervalo,station,month)
            ...
            if sertest['OBSERVACION'].isnull().all():
                ...
                figstr = '../figures/scatter/{}/scatterPlot_st_{}_m_{}'.format(intervalo,station,month)
                plt.savefig(figstr)
                plt.clf()
            k = k + 1
        j = j + 1
